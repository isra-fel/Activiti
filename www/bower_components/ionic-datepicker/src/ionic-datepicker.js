  ...
  .directive('ionicDatepicker', ['$ionicPopup', function ($ionicPopup) {
    return {
      ...
      link: function (scope, element, attrs) {
        ...
        var monthsListCN = ["一月", "二月", "三月", "四月", "五月", "六月", "七月",
          "八月", "九月", "十月", "十一月", "十二月"];
        var monthsListEN = ["January", "February", "March", "April", "May", "June", "July",
          "August", "September", "October", "November", "December"];
        var monthsList = monthsListCN;
        ...
        var weekNamesEN = ['S', 'M', 'T', 'W', 'T', 'F', 'S'];
        var weekNamesCN = ['日', '一', '二', '三', '四', '五', '六'];
        scope.weekNames = weekNamesCN; 
