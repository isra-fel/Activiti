...
//    document.getElementsByTagName("body")[0].innerHTML += resulttime;
//    document.getElementsByTagName("body")[0].innerHTML += ":";
//    document.getElementsByTagName("body")[0].innerHTML += resultplace;
};
...
//调用此函数即可，有四个参数，返回三个，第一个是是否，第二是时间，第三是地点
...
////////////////////////////////////////////////////
        ...
        if(time.indexOf("月")!=-1){
            ...
            if(time.indexOf("十一月")!=-1||time.indexOf("11月")!=-1){
                mb=mt=10;
            }else if(time.indexOf("十二月")!=-1||time.indexOf("12月")!=-1){
                mb=mt=11;
            }else{
                switch(time[index]){
        ...
        if(time.indexOf("星期")!=-1){
            ...
            if(time.indexOf("下星期")!=-1){
                ...
                dt=(db+7)%daysofmonth;
                if((weekandday+14)/daysofmonth>=1){
                    mb=mt=month+1;
                }else
                    mb=mt=month;
        ...
        console.log(yb+","+yt+","+mb+","+mt+","+db+","+dt+","+hb+","+ht+","+wb+","+wt);
